...
DefineUnitType("unit-footman", { Name = "Footman",
  ...
  Size = {72, 72},
  NewAnimations = "animations-footman", Icon = "icon-footman",
...
DefineUnitType("unit-peasant", { Name = "Peasant",
  ...
  Size = {72, 72},
  DrawLevel = 19,
  NewAnimations = "animations-peasant", Icon = "icon-peasant",
...
DefineUnitType("unit-ballista", { Name = "Ballista",
  ...
  Size = {64, 64},
  NewAnimations = "animations-ballista", Icon = "icon-ballista",
...
DefineUnitType("unit-knight", { Name = "Knight",
  ...
  Size = {72, 72},
  NewAnimations = "animations-knight", Icon = "icon-knight",
...
DefineUnitType("unit-archer", { Name = "Archer",
  ...
  Size = {72, 72},
  NewAnimations = "animations-archer", Icon = "icon-archer",
...
DefineUnitType("unit-mage", { Name = "Mage",
  ...
  Size = {72, 72},
  NewAnimations = "animations-mage", Icon = "icon-mage",
...
DefineUnitType("unit-paladin", { Name = "Paladin",
  Files = {"tileset-summer", "human/units/knight.png"},
  Size = {72, 72},
  NewAnimations = "animations-paladin", Icon = "icon-paladin",
  Costs = {"time", 90, "gold", 800, "wood", 100},
  Speed = 13,
  HitPoints = 90,
  DrawLevel = 40,
...
DefineUnitType("unit-dwarves", { Name = "Dwarves",
  ...
  Size = {56, 56},
  NewAnimations = "animations-dwarves", Icon = "icon-dwarves",
...
DefineUnitType("unit-ranger", { Name = "Ranger",
  Files = {"tileset-summer", "human/units/elven_archer.png"},
  Size = {72, 72},
  NewAnimations = "animations-ranger", Icon = "icon-ranger",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Speed = 10,
  HitPoints = 50,
  DrawLevel = 40,
...
DefineUnitType("unit-female-hero", { Name = "Alleria",
  Files = {"tileset-summer", "human/units/elven_archer.png"},
  Size = {72, 72},
  NewAnimations = "animations-female-hero", Icon = "icon-female-hero",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Speed = 10,
  HitPoints = 120,
  DrawLevel = 40,
...
DefineUnitType("unit-gryphon-rider", { Name = "Gryphon Rider",
  ...
  Size = {80, 80},
  DrawLevel = 45,
  NewAnimations = "animations-gryphon-rider", Icon = "icon-gryphon-rider",
...
DefineUnitType("unit-flying-angle", { Name = "Kurdan and Sky'ree",
  ...
  Size = {80, 80},
  DrawLevel = 45,
  NewAnimations = "animations-flying-angle", Icon = "icon-flying-angle",
  Costs = {"time", 250, "gold", 2500},
  Speed = 14,
  HitPoints = 250,
  DrawLevel = 60,
...
DefineUnitType("unit-white-mage", { Name = "Khadgar",
  Files = {"tileset-summer", "human/units/mage.png"},
  Size = {72, 72},
  NewAnimations = "animations-white-mage", Icon = "icon-white-mage",
  Costs = {"time", 120, "gold", 1200},
  Speed = 8,
  HitPoints = 120,
  DrawLevel = 40,
...
DefineUnitType("unit-human-oil-tanker", { Name = "Oil tanker",
  ...
  Size = {72, 72},
  NewAnimations = "animations-human-oil-tanker", Icon = "icon-human-oil-tanker",
...
DefineUnitType("unit-human-transport", { Name = "Transport",
  ...
  Size = {72, 72},
  NewAnimations = "animations-human-transport", Icon = "icon-human-transport",
...
DefineUnitType("unit-human-destroyer", { Name = "Elven Destroyer",
  ...
  Size = {80, 88},
  NewAnimations = "animations-elven-destroyer", Icon = "icon-human-destroyer",
...
DefineUnitType("unit-battleship", { Name = "Battleship",
  ...
  Size = {88, 88},
  NewAnimations = "animations-battleship", Icon = "icon-battleship",
...
DefineUnitType("unit-human-submarine", { Name = "Gnomish Submarine",
  ...
  Size = {72, 72},
  NewAnimations = "animations-gnomish-submarine", Icon = "icon-gnomish-submarine",
...
DefineUnitType("unit-balloon", { Name = "Gnomish Flying Machine",
  ...
  Size = {80, 80},
  NewAnimations = "animations-balloon", Icon = "icon-gnomish-flying-machine",
...
DefineUnitType("unit-knight-rider", { Name = "Turalyon",
  Files = {"tileset-summer", "human/units/knight.png"},
  Size = {72, 72},
  NewAnimations = "animations-knight-rider", Icon = "icon-knight-rider",
  Costs = {"time", 90, "gold", 800, "wood", 100},
  Speed = 13,
  HitPoints = 180,
  DrawLevel = 40,
...
DefineUnitType("unit-arthor-literios", { Name = "Danath",
  Files = {"tileset-summer", "human/units/footman.png"},
  Size = {72, 72},
  NewAnimations = "animations-arthor-literios", Icon = "icon-ugly-guy",
  Costs = {"time", 60, "gold", 600},
  Speed = 10,
  HitPoints = 220,
  DrawLevel = 40,
...
DefineUnitType("unit-wise-man", { Name = "Lothar",
  Files = {"tileset-summer", "human/units/knight.png"},
  Size = {72, 72},
  NewAnimations = "animations-wise-man", Icon = "icon-wise-man",
...
DefineUnitType("unit-man-of-light", { Name = "Uther Lightbringer",
  Files = {"tileset-summer", "human/units/knight.png"},
  Size = {72, 72},
  NewAnimations = "animations-man-of-light", Icon = "icon-man-of-light",
  Costs = {"time", 100, "gold", 900, "wood", 100},
  Speed = 13,
  HitPoints = 90,
  DrawLevel = 40,
...
DefineUnitType("unit-farm", { Name = "Farm",
  ...
  Size = {64, 64},
  NewAnimations = "animations-building", Icon = "icon-farm",
...
DefineUnitType("unit-human-barracks", { Name = "Barracks",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-human-barracks",
...
DefineUnitType("unit-church", { Name = "Church",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-church",
...
DefineUnitType("unit-human-watch-tower", { Name = "Scout Tower",
  ...
  Size = {64, 64},
  NewAnimations = "animations-building", Icon = "icon-human-watch-tower",
...
DefineUnitType("unit-stables", { Name = "Stables",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-stables",
...
DefineUnitType("unit-inventor", { Name = "Gnomish Inventor",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-gnomish-inventor",
...
DefineUnitType("unit-gryphon-aviary", { Name = "Gryphon Aviary",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-gryphon-aviary",
  Costs = {"time", 150, "gold", 1000, "wood", 400},
  RepairHp = 4,
  RepairCosts = {"gold", 1, "wood", 1},
  Construction = "construction-land",
...
DefineUnitType("unit-human-shipyard", { Name = "Shipyard",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-human-shipyard",
...
DefineUnitType("unit-elven-lumber-mill", { Name = "Elven Lumber Mill",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-elven-lumber-mill",
...
DefineUnitType("unit-human-foundry", { Name = "Foundry",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-human-foundry",
...
DefineUnitType("unit-town-hall", { Name = "Town Hall",
  ...
  Size = {128, 128},
  NewAnimations = "animations-building", Icon = "icon-town-hall",
...
DefineUnitType("unit-mage-tower", { Name = "Mage Tower",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-mage-tower",
...
DefineUnitType("unit-human-blacksmith", { Name = "Blacksmith",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-human-blacksmith",
...
DefineUnitType("unit-human-refinery", { Name = "Refinery",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-human-refinery",
...
DefineUnitType("unit-human-oil-platform", { Name = "Oil Platform",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-human-oil-platform",
  Costs = {"time", 200, "gold", 700, "wood", 450},
...
DefineUnitType("unit-keep", { Name = "Keep",
  ...
  Size = {128, 128},
  NewAnimations = "animations-building", Icon = "icon-keep",
...
DefineUnitType("unit-castle", { Name = "Castle",
  ...
  Size = {128, 128},
  NewAnimations = "animations-building", Icon = "icon-castle",
...
DefineUnitType("unit-human-guard-tower", { Name = "Guard Tower",
  ...
  Size = {64, 64},
  NewAnimations = "animations-human-guard-tower", Icon = "icon-human-guard-tower",
...
DefineUnitType("unit-human-cannon-tower", { Name = "Cannon Tower",
  ...
  Size = {64, 64},
  NewAnimations = "animations-human-cannon-tower", Icon = "icon-human-cannon-tower",
...
DefineUnitType("unit-human-wall", { Name = "Wall",
  ...
  Size = {32, 32},
  NewAnimations = "animations-building", Icon = "icon-human-wall",
