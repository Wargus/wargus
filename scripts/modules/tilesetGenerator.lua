...
local tilesetGenerator = {
  seed = {
          lowgroundWeakGround   = nil,
          lowgroundSolidGround  = nil,
          highgroundWeakGround  = nil,
          highgroundSolidGround = nil,
          getRampSrcSlot        = nil,
          getRampSrc            = nil,
          generators            = nil,
          dim                   = nil,
...
function tilesetGenerator.debug.tableToString(toPrint) -- used for testing purposes
...
function tilesetGenerator:ExtendTileset()
  
  local lowgroundWeakGround   = self.seed.lowgroundWeakGround
  local lowgroundSolidGround  = self.seed.lowgroundSolidGround
  local highgroundWeakGround  = self.seed.highgroundWeakGround
  local highgroundSolidGround = self.seed.highgroundSolidGround

  local getRampSrcSlot = self.seed.getRampSrcSlot
  local getRampSrc     = self.seed.getRampSrc

  local generators     = self.seed.generators
  local cliffGen       = generators.cliffs

  local dim            = self.seed.dim
  local lighten        = self.seed.lighten
