...
--
--      caanoo-units.lua - Define the Caanoo campaign unit-types.
--
...
-- Spell Related
Load("scripts/caanoo/caanoo-unit-foundations.lua")
Load("scripts/caanoo/caanoo-spells.lua")

-- Units
Load("scripts/caanoo/caanoo-unit-heroes.lua")
