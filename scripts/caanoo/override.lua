...
DefineUnitType("unit-elven-lumber-mill", { Name = _("Lumber Mill"),
  Image = {"size", {96, 96}},
...
DefineUnitType("unit-archer", { Name = _("Yeoman"),
...
DefineUnitType("unit-axethrower", { Name = _("Feral Axethrower"),
...
DefineUnitType("unit-grunt", { Name = _("Wild Knight"),
  Image = {"file", "size", "size", {72, 72}},
...
DefineUnitType("unit-peon", { Name = _("Fawn"),
...
DefineUnitType("unit-fire-breeze", { Name = _("Evil Dragon"),
