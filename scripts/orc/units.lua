...
DefineUnitType("unit-grunt", { Name = "Grunt",
  ...
  Size = {72, 72},
  NewAnimations = "animations-grunt", Icon = "icon-grunt",
...
DefineUnitType("unit-peon", { Name = "Peon",
  ...
  Size = {72, 72},
  NewAnimations = "animations-peon", Icon = "icon-peon",
...
DefineUnitType("unit-catapult", { Name = "Catapult",
  ...
  Size = {64, 64},
  NewAnimations = "animations-catapult", Icon = "icon-catapult",
...
DefineUnitType("unit-ogre", { Name = "Ogre",
  ...
  Size = {72, 72},
  NewAnimations = "animations-ogre", Icon = "icon-ogre",
...
DefineUnitType("unit-axethrower", { Name = "Troll Axethrower",
  ...
  Size = {72, 72},
  NewAnimations = "animations-axethrower", Icon = "icon-axethrower",
...
DefineUnitType("unit-death-knight", { Name = "Death Knight",
  ...
  Size = {72, 72},
  NewAnimations = "animations-death-knight", Icon = "icon-death-knight",
...
DefineUnitType("unit-ogre-mage", { Name = "Ogre Mage",
  Files = {"tileset-summer", "orc/units/ogre.png"},
  Size = {72, 72},
  NewAnimations = "animations-ogre-mage", Icon = "icon-ogre-mage",
  Costs = {"time", 90, "gold", 800, "wood", 100},
  Speed = 13,
  HitPoints = 90,
  DrawLevel = 40,
...
DefineUnitType("unit-goblin-sappers", { Name = "Goblin Sappers",
  ...
  Size = {56, 56},
  NewAnimations = "animations-goblin-sappers", Icon = "icon-goblin-sappers",
...
DefineUnitType("unit-berserker", { Name = "Berserker",
  Files = {"tileset-summer", "orc/units/troll_axethrower.png"},
  Size = {72, 72},
  NewAnimations = "animations-axethrower", Icon = "icon-berserker",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Speed = 10,
  HitPoints = 50,
  DrawLevel = 40,
...
DefineUnitType("unit-evil-knight", { Name = "Teron Gorefiend",
  Files = {"tileset-summer", "orc/units/death_knight.png"},
  Size = {72, 72},
  NewAnimations = "animations-death-knight", Icon = "icon-evil-knight",
  Costs = {"time", 120, "gold", 1200},
  Speed = 8,
  HitPoints = 180,
  DrawLevel = 40,
...
DefineUnitType("unit-fad-man", { Name = "Dentarg",
  Files = {"tileset-summer", "orc/units/ogre.png"},
  Size = {72, 72},
  NewAnimations = "animations-ogre", Icon = "icon-fad-man",
  Costs = {"time", 90, "gold", 800, "wood", 100},
  Speed = 13,
  HitPoints = 300,
  DrawLevel = 40,
...
DefineUnitType("unit-beast-cry", { Name = "Grom Hellscream",
  Files = {"tileset-summer", "orc/units/grunt.png"},
  Size = {72, 72},
  NewAnimations = "animations-footman", Icon = "icon-beast-cry",
  Costs = {"time", 60, "gold", 600},
  Speed = 10,
  HitPoints = 240,
  DrawLevel = 40,
...
DefineUnitType("unit-orc-oil-tanker", { Name = "Oil tanker",
  ...
  Size = {72, 72},
  NewAnimations = "animations-orc-oil-tanker", Icon = "icon-orc-oil-tanker",
...
DefineUnitType("unit-orc-transport", { Name = "Transport",
  ...
  Size = {72, 72},
  NewAnimations = "animations-orc-transport", Icon = "icon-orc-transport",
...
DefineUnitType("unit-ogre-juggernaught", { Name = "Ogre Juggernaught",
  ...
  Size = {88, 88},
  NewAnimations = "animations-battleship", Icon = "icon-ogre-juggernaught",
...
DefineUnitType("unit-dragon", { Name = "Dragon",
  ...
  Size = {88, 80},
  NewAnimations = "animations-dragon", Icon = "icon-dragon",
...
DefineUnitType("unit-fire-breeze", { Name = "Deathwing",
  Files = {"tileset-summer", "orc/units/dragon.png"},
  Size = {88, 80},
  NewAnimations = "animations-fire-breeze", Icon = "icon-fire-breeze",
  Costs = {"time", 250, "gold", 2500},
  Speed = 14,
  HitPoints = 800,
  DrawLevel = 60,
...
DefineUnitType("unit-orc-submarine", { Name = "Giant Turtle",
  ...
  Size = {72, 72},
  NewAnimations = "animations-orc-submarine", Icon = "icon-giant-turtle",
...
DefineUnitType("unit-zeppelin", { Name = "Goblin Zeppelin",
  ...
  Size = {72, 72},
  NewAnimations = "animations-goblin-zeppelin", Icon = "icon-zeppelin",
...
DefineUnitType("unit-eye-of-vision", { Name = "Eye of Kilrogg",
  ...
  Size = {32, 32},
  NewAnimations = "animations-eye-of-vision", Icon = "icon-eye-of-kilrogg",
  Speed = 42,
  HitPoints = 100,
  DrawLevel = 60,
  TileSize = {1, 1}, BoxSize = {31, 31},
...
DefineUnitType("unit-quick-blade", { Name = "Korgath Bladefist",
  Files = {"tileset-summer", "orc/units/grunt.png"},
  Size = {72, 72},
  NewAnimations = "animations-quick-blade", Icon = "icon-quick-blade",
  Costs = {"time", 60, "gold", 600},
  Speed = 10,
  HitPoints = 240,
  DrawLevel = 40,
...
DefineUnitType("unit-double-head", { Name = "Cho'gall",
  Files = {"tileset-summer", "orc/units/ogre.png"},
  Size = {72, 72},
  NewAnimations = "animations-double-head", Icon = "icon-double-head",
...
DefineUnitType("unit-ice-bringer", { Name = "Gul'dan",
  Files = {"tileset-summer", "orc/units/death_knight.png"},
  Size = {72, 72},
  NewAnimations = "animations-ice-bringer", Icon = "icon-ice-bringer",
  Costs = {"time", 120, "gold", 1200},
  Speed = 8,
  HitPoints = 40,
  DrawLevel = 40,
...
DefineUnitType("unit-sharp-axe", { Name = "Zuljin",
  Files = {"tileset-summer", "orc/units/troll_axethrower.png"},
  Size = {72, 72},
  NewAnimations = "animations-sharp-axe", Icon = "icon-sharp-axe",
  Costs = {"time", 70, "gold", 500, "wood", 50},
  Speed = 10,
  HitPoints = 40,
  DrawLevel = 40,
...
DefineUnitType("unit-skeleton", { Name = "Skeleton",
  ...
  Size = {56, 56},
  NewAnimations = "animations-skeleton", Icon = "icon-skeleton",
  Speed = 8,
  HitPoints = 40,
  DrawLevel = 40,
  TileSize = {1, 1}, BoxSize = {31, 31},
...
DefineUnitType("unit-pig-farm", { Name = "Pig Farm",
  ...
  Size = {64, 64},
  NewAnimations = "animations-building", Icon = "icon-pig-farm",
...
DefineUnitType("unit-orc-barracks", { Name = "Barracks",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-orc-barracks",
...
DefineUnitType("unit-altar-of-storms", { Name = "Altar of Storms",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-altar-of-storms",
...
DefineUnitType("unit-orc-watch-tower", { Name = "Watch Tower",
  ...
  Size = {64, 64},
  NewAnimations = "animations-building", Icon = "icon-orc-watch-tower",
...
DefineUnitType("unit-ogre-mound", { Name = "Ogre Mound",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-ogre-mound",
...
DefineUnitType("unit-alchemist", { Name = "Goblin Alchemist",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-alchemist",
...
DefineUnitType("unit-dragon-roost", { Name = "Dragon Roost",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-dragon-roost",
  Costs = {"time", 150, "gold", 1000, "wood", 400},
  RepairHp = 4,
  RepairCosts = {"gold", 1, "wood", 1},
  Construction = "construction-land",
...
DefineUnitType("unit-orc-shipyard", { Name = "Shipyard",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-orc-shipyard",
...
DefineUnitType("unit-great-hall", { Name = "Great Hall",
  ...
  Size = {128, 128},
  NewAnimations = "animations-building", Icon = "icon-great-hall",
...
DefineUnitType("unit-troll-lumber-mill", { Name = "Troll Lumber Mill",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-troll-lumber-mill",
...
DefineUnitType("unit-orc-foundry", { Name = "Foundry",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-orc-foundry",
...
DefineUnitType("unit-temple-of-the-damned", { Name = "Temple of the Damned",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-temple-of-the-damned",
...
DefineUnitType("unit-orc-blacksmith", { Name = "Blacksmith",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-orc-blacksmith",
...
DefineUnitType("unit-orc-refinery", { Name = "Refinery",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-orc-refinery",
...
DefineUnitType("unit-orc-oil-platform", { Name = "Oil Platform",
  ...
  Size = {96, 96},
  NewAnimations = "animations-building", Icon = "icon-orc-oil-platform",
  Costs = {"time", 200, "gold", 700, "wood", 450},
...
DefineUnitType("unit-stronghold", { Name = "Stronghold",
  ...
  Size = {128, 128},
  NewAnimations = "animations-building", Icon = "icon-stronghold",
...
DefineUnitType("unit-fortress", { Name = "Fortress",
  ...
  Size = {128, 128},
  NewAnimations = "animations-building", Icon = "icon-fortress",
...
DefineUnitType("unit-orc-guard-tower", { Name = "Guard Tower",
  ...
  Size = {64, 64},
  NewAnimations = "animations-orc-guard-tower", Icon = "icon-orc-guard-tower",
...
DefineUnitType("unit-orc-cannon-tower", { Name = "Cannon Tower",
  ...
  Size = {64, 64},
  NewAnimations = "animations-orc-cannon-tower", Icon = "icon-orc-cannon-tower",
...
DefineUnitType("unit-orc-wall", { Name = "Wall",
  ...
  Size = {32, 32},
  NewAnimations = "animations-building", Icon = "icon-orc-wall",
