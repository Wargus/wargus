...
AddResizedFiller("ui/orc/filler-right.png", Video.Width - 16, 0, 16, Video.Height)
AddResizedFiller("ui/orc/resource.png", 176, 0, Video.Width - 192, 16)
AddResizedFiller("ui/orc/statusline.png", 176, Video.Height - 16, Video.Width - 192, 16)
AddResizedFiller("ui/orc/buttonpanel.png", 0, 336, 176, 144 + Video.Height - 480)
