...
--
--      ui.lua - Define the mythic user interface
--
--      (c) Copyright 2001-2013 by Lutz Sammer, Kyran Jackson and Jimmy Salmon.
--
...
if (((Video.Width == 640) and (Video.Height == 480)) or
   ...
   ((Video.Width == 1680) and (Video.Height == 1050))) then
	...
	if (Video.Width <= 640) then
		AddFiller("ui/orc/640x480/resource.png", 176, 0)
		AddFiller("ui/orc/640x480/statusline.png", 176, Video.Height - 16)
	else
		if (Video.Width <= 800) then
			AddFiller("ui/orc/800x480/resource.png", 176, 0)
			AddFiller("ui/orc/800x480/statusline.png", 176, Video.Height - 16)
		else
			if (Video.Width <= 1024) then
				AddFiller("ui/orc/1024x768/resource.png", 176, 0)
				AddFiller("ui/orc/1024x768/statusline.png", 176, Video.Height - 16)
			else
				if (Video.Width <= 1280) then
					AddFiller("ui/orc/1280x800/resource.png", 176, 0)
					AddFiller("ui/orc/1280x800/statusline.png", 176, Video.Height - 16)
				else
					if (Video.Width <= 1400) then
						AddFiller("ui/orc/1400x1050/resource.png", 176, 0)
						AddFiller("ui/orc/1400x1050/statusline.png", 176, Video.Height - 16)
					else
						if (Video.Width <= 1600) then
							AddFiller("ui/orc/1600x1200/resource.png", 176, 0)
							AddFiller("ui/orc/1600x1200/statusline.png", 176, Video.Height - 16)
						else
							AddFiller("ui/orc/1680x1050/resource.png", 176, 0)
							AddFiller("ui/orc/1680x1050/statusline.png", 176, Video.Height - 16)
						end
					end
				end
			end
	...
	if (Video.Height <= 480) then
		AddFiller("ui/orc/640x480/filler-right.png", Video.Width - 16, 0)
		AddFiller("ui/orc/640x480/buttonpanel.png", 0, 336)
	else
		if (Video.Height <= 600) then
			AddFiller("ui/orc/800x600/filler-right.png", Video.Width - 16, 0)
			AddFiller("ui/orc/800x600/buttonpanel.png", 0, 336)
		else
			if (Video.Height <= 768) then
				AddFiller("ui/orc/1024x768/filler-right.png", Video.Width - 16, 0)
				AddFiller("ui/orc/1024x768/buttonpanel.png", 0, 336)
			else
				if (Video.Height <= 800) then
					AddFiller("ui/orc/1280x800/filler-right.png", Video.Width - 16, 0)
					AddFiller("ui/orc/1280x800/buttonpanel.png", 0, 336)
				else
					if (Video.Height <= 960) then
						AddFiller("ui/orc/1280x960/filler-right.png", Video.Width - 16, 0)
						AddFiller("ui/orc/1280x960/buttonpanel.png", 0, 336)
					else
						if (Video.Height <= 1024) then
							AddFiller("ui/orc/1280x1024/filler-right.png", Video.Width - 16, 0)
							AddFiller("ui/orc/1280x1024/buttonpanel.png", 0, 336)
						else
							if (Video.Height <= 1050) then
								AddFiller("ui/orc/1400x1050/filler-right.png", Video.Width - 16, 0)
								AddFiller("ui/orc/1400x1050/buttonpanel.png", 0, 336)
							else
								AddFiller("ui/orc/1600x1200/filler-right.png", Video.Width - 16, 0)
								AddFiller("ui/orc/1600x1200/buttonpanel.png", 0, 336)
							end
						end
					end
				end
...
UI.InfoPanel.X = 0
UI.InfoPanel.Y = 160
UI.InfoPanel.G = CGraphic:New("ui/orc/infopanel.png", 176, 176)
